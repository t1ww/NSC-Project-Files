...
function PlayerStatewithGun1(){
	//Movement
hSpeed = lengthdir_x(InputMagnitude * WalkGun1, InputDirection);
vSpeed = lengthdir_y(InputMagnitude * WalkGun1, InputDirection);
//Collision
PlayerCollision();
